...
const AdminReport = () => {
  ...
  const [allPlanss, setAllPlans] = useState([]);
      ...
      <table>
        ...
        {studentInClass.map(student => {
          ...
          return <tr>
              ...
              <td>{allSchools.map(school => {
                //   if(school.id === student.studentClasses[0].school)
                //   {
                //     return <td>{school.schoolName}</td>
                //   }
               
                  if(student.studentClasses[0] && school.id === student.studentClasses[0].school || student.matatzClasses[0] && school.id === student.matatzClasses[0].school)
     
                {
                   
                   return <p>{allPlanss.map(plan => {
                    if(school.plan === plan.id){
                            return  <td>{plan.planName}</td>
...
if(student.studentClasses[0] && school.id === student.studentClasses[0].school || student.matatzClasses[0] && school.id === student.matatzClasses[0].school)
{
    return <td>{school.schoolName}</td>
            ...
            {/* find the teacher of the student */}
          
            <td>{student.userType==="1"?student.studentClasses[0].className:""}</td>
            {allTeachers && allTeachers.map(teacher => {
             ...
             <td>{nameOfTeacher}</td>
              {/* <td>{console.log("yyyyyyy", student.studentClasses[0])}</td> */}
